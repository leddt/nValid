...
namespace nValid.Validators
{
    public class ListEmptyValidator<TInstance, TItem> : IValidator<TInstance,IList<TItem>>
    {
        ...
        {
            get { return ValidationContext.Current.GetResourceString("nValid_ListEmpty_DefaultMessage"); }
        }

        public string DefaultNegatedErrorMessage
        {
            get { return ValidationContext.Current.GetResourceString("nValid_ListEmpty_DefaultMessage_Negated"); }
        }
