...
{
    public class GreaterOrEqualToValidatorTests : TestBase
    {
        [Test]
        public void Should_be_valid_when_value_is_greater()
        {
            var validator = new GreaterOrEqualToValidator<Person, int>(18);
        ...
        {
            var validator = new GreaterOrEqualToValidator<Person, int>(10);
